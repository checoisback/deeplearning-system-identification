function [bolus, basal, bolusDelayed, basalDelayed] = insulinSetupPF(data,model,modelParameters)
...
% ---------------------------------------------------------------------
    ...
    bolusDelay = round(bolusDelay/5)*5;
    ...
    basal = basal(1:model.TIDSTEPS);
    bolus = bolus(1:model.TIDSTEPS);
